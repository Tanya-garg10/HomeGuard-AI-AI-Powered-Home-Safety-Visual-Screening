...
app.post(
  ...
  async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      // If no Gemini API key configured, provide structured simulated fallback
      if (!apiKey) {
        console.warn('GEMINI_API_KEY is not set. Returning high-fidelity fallback screening.');
